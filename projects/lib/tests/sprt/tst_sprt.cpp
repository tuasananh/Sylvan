...
void tst_Sprt::sprt_data() const {
  ...
  QTest::newRow("test1") << 0.0 << 10.0 << 0.01 << 0.01 << 1477 << 1351 << 2942
                         << 2.52 << -4.6 << 4.6;

  QTest::newRow("test2") << 0.0 << 10.0 << 0.01 << 0.01 << 555 << 555 << 298
                         << -0.74 << -4.6 << 4.6;

  QTest::newRow("test3") << 0.0 << 10.0 << 0.01 << 0.01 << 3 << 149 << 1 << -4.6
                         << -4.6 << 4.6;
}
