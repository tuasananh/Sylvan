...
tst_Board::tst_Board() : m_board(0) {}

void tst_Board::cleanupTestCase() { delete m_board; }
...
static quint64 perftVal(Chess::Board* board, int depth) {
  ...
  if (depth == 1 || moves.size() == 0) return moves.size();
...
static quint64 perftRoot(const Chess::Board* board, const Chess::Move& move,
                         int depth) {
...
void tst_Board::zobristKeys_data() const {
  ...
  QTest::newRow("startpos")
      << variant << "rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1"
      << Q_UINT64_C(0x463b96181691fc9c);
  QTest::newRow("e2e4")
      << variant << "rnbqkbnr/pppppppp/8/8/4P3/8/PPPP1PPP/RNBQKBNR b KQkq e3"
      << Q_UINT64_C(0x823c9b50fd114196);
  QTest::newRow("e2e4 d7d5")
      << variant << "rnbqkbnr/ppp1pppp/8/3p4/4P3/8/PPPP1PPP/RNBQKBNR w KQkq d6"
      << Q_UINT64_C(0x0756b94461c50fb0);
  QTest::newRow("e2e4 d7d5 e4e5")
      << variant << "rnbqkbnr/ppp1pppp/8/3pP3/8/8/PPPP1PPP/RNBQKBNR b KQkq -"
      << Q_UINT64_C(0x662fafb965db29d4);
  QTest::newRow("e2e4 d7d5 e4e5 f7f5")
      << variant << "rnbqkbnr/ppp1p1pp/8/3pPp2/8/8/PPPP1PPP/RNBQKBNR w KQkq f6"
      << Q_UINT64_C(0x22a48b5a8e47ff78);
  QTest::newRow("e2e4 d7d5 e4e5 f7f5 e1e2")
      << variant << "rnbqkbnr/ppp1p1pp/8/3pPp2/8/8/PPPPKPPP/RNBQ1BNR b kq -"
      << Q_UINT64_C(0x652a607ca3f242c1);
  QTest::newRow("e2e4 d7d5 e4e5 f7f5 e1e2 e8f7")
      << variant << "rnbq1bnr/ppp1pkpp/8/3pPp2/8/8/PPPPKPPP/RNBQ1BNR w - -"
      << Q_UINT64_C(0x00fdd303c946bdd9);
  QTest::newRow("a2a4 b7b5 h2h4 b5b4 c2c4")
      << variant << "rnbqkbnr/p1pppppp/8/8/PpP4P/8/1P1PPPP1/RNBQKBNR b KQkq c3"
      << Q_UINT64_C(0x3c8123ea7b067637);
  QTest::newRow("a2a4 b7b5 h2h4 b5b4 c2c4 b4c3 a1a3")
      << variant << "rnbqkbnr/p1pppppp/8/8/P6P/R1p5/1P1PPPP1/1NBQKBNR b Kkq -"
...
void tst_Board::moveStrings_data() const {
  ...
  QTest::newRow("embassy castling san1")
      << "embassy"
      << "O-O-O O-O-O Ng4"
      << "r3kcab1r/pppq1p1ppp/2np2pn2/4pb4/4B5/2NPB1PN2/PPPQPP1PPP/R3KCA2R b "
         "KQkq - 3 1"
      << "1kr2cab1r/pppq1p1ppp/2np2p3/4pb4/4B1n3/2NPB1PN2/PPPQPP1PPP/1KR2CA2R "
         "w - - 6 3";
  QTest::newRow("embassy castling san2")
      << "embassy"
      << "Cf1 O-O g3"
      << "r2qk4r/ppp4cpp/3p1ppba1/4nb1p2/2P1N1nB2/P1KP2CNP1/1P2P1PP1P/R5AB1R w "
         "kq - 0 1"
      << "r2q2rk2/ppp4cpp/3p1ppba1/4nb1p2/2P1N1nB2/P1KP2PNP1/1P2P2P1P/R4CAB1R "
         "b - - 0 2";
  ...
  QTest::newRow("janus castling san1")
      << "janus"
      << "Kb8 Be3 Ng6 Ki1"
      << "r3kqbnjr/pppp1ppppp/2jn1b4/4p5/4P5/3Q1PNJ2/PPPP2PPPP/RJNBK1B2R b "
         "KQkq - 0 1"
      << "1kr2qb1jr/pppp1ppppp/2jn1bn3/4p5/4P5/3QBPNJ2/PPPP2PPPP/RJNB3RK1 b - "
         "- 4 3";
  ...
  QTest::newRow("modern castling san1")
      << "modern"
      << "O-Q-O O-M-O"
      << "r1bqk3r/ppp3ppp/2n3n2/2mbpp3/3p5/3B1P3/P1NQPMN2/1PPP2PPP/R1B1K3R w "
         "KQkq - 0 1"
      << "r1bq1rk2/ppp3ppp/2n3n2/2mbpp3/3p5/3B1P3/P1NQPMN2/1PPP2PPP/R1B2RK2 w "
         "- - 2 2";
  ...
  QTest::newRow("grand lan1") << "grand"
                              << "d10d9 f5f6 g8g6 f6g7"
                              << "3r6/1nb1kcabn1/ppprpppppp/3q6/3p6/5P4/5C4/"
                                 "PPPPPRPPPP/1NBQKRABN1/10 b - - 0 1"
                              << "10/1nbrkcabn1/ppprpp1ppp/3q2P3/3p6/10/5C4/"
                                 "PPPPPRPPPP/1NBQKRABN1/10 b - - 0 3";
  QTest::newRow("grand san1") << "grand"
                              << "R10d9 f6 g6 fxg7"
                              << "3r6/1nb1kcabn1/ppprpppppp/3q6/3p6/5P4/5C4/"
                                 "PPPPPRPPPP/1NBQKRABN1/10 b - - 0 1"
                              << "10/1nbrkcabn1/ppprpp1ppp/3q2P3/3p6/10/5C4/"
  ...
  QTest::newRow("seirawan san1")
      ...
      << "rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR[EHeh] w bcdfgBCDFGKQkq - "
         "0 1"
      << "rnbqerk1/pppp1ppp/3b1n1h/4p3/2B1P3/2N2N2/PPPP1PPP/RHBQ1RKE[-] w - - "
         "0 6";
  ...
  QTest::newRow("asean san2 promotion") << "asean"
                                        << "h8=R Kc3"
  ...
  QTest::newRow("gustav3 san1") << "gustav3"
                                << "Ab3 Ai6 Ng3"
                                << "arnbqkbnra/*pppppppp*/*8*/*8*/*8*/*8*/"
                                   "*PPPPPPPP*/ARNBQKBNRA w KQkq - 0 1"
                                << "arnbqkbnr1/*pppppppp*/*7a*/*8*/*8*/*A4N2*/"
                                   "*PPPPPPPP*/1RNBQKB1RA b KQkq - 3 2";
...
void tst_Board::moveStrings() {
  ...
  if (!moveList.isEmpty()) {
    for (int i = 0; i < moveList.size(); i++) m_board->undoMove();
...
void tst_Board::results_data() const {
  ...
  QTest::newRow("standard startpos")
      << variant << "rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1"
      << "*";
  QTest::newRow("unfinished #1") << variant << "2K1k3/8/2r5/8/8/8/8/8 w - - 0 1"
                                 << "*";
  QTest::newRow("mate #1") << variant << "2K1r3/8/2k5/8/8/8/8/8 w - - 0 1"
                           << "0-1";
  QTest::newRow("stalemate #1") << variant << "k7/8/K7/8/1R6/8/8/8 b - - 0 1"
                                << "1/2-1/2";
  QTest::newRow("Kk") << variant << "2K5/8/2k5/8/8/8/8/8 w - - 0 1"
                      << "1/2-1/2";
  QTest::newRow("KNk") << variant << "2K5/4N3/2k5/8/8/8/8/8 b - - 0 1"
                       << "1/2-1/2";
  QTest::newRow("KBk") << variant << "2K5/4B3/2k5/8/8/8/8/8 b - - 0 1"
                       << "1/2-1/2";
  QTest::newRow("KBNk") << variant << "2K5/4BN2/2k5/8/8/8/8/8 b - - 0 1"
                        << "*";
  QTest::newRow("KBBk #1") << variant << "2K5/4BB2/2k5/8/8/8/8/8 b - - 0 1"
                           << "*";
  QTest::newRow("KBBkb #1") << variant << "2K5/4B3/2k2B2/8/8/3b4/8/8 b - - 0 1"
                            << "*";
  QTest::newRow("KBBk #2") << variant << "2K5/4B3/2k2B2/8/8/8/8/8 b - - 0 1"
                           << "1/2-1/2";
  QTest::newRow("KBBkb #2") << variant << "2K5/4B3/2k2B2/8/8/4b3/8/8 b - - 0 1"
                            << "1/2-1/2";
  QTest::newRow("No fifty moves yet #1")
      << variant << "8/k7/2K5/8/8/8/R7/8 b - - 99 1"
      << "*";
  QTest::newRow("Fifty moves draw")
      << variant << "8/k7/2K5/8/8/8/R7/8 b - - 100 1"
      << "1/2-1/2";
  QTest::newRow("Fifty moves mate")
      << variant << "8/8/k1K5/8/8/8/R7/8 b - - 100 1"
      << "1-0";

  variant = "kingofthehill";

  QTest::newRow("KOTH unfinished #1")
      << variant << "r1b3nr/1pp2ppp/p7/2kp4/BP1p4/2PK1N2/P4PPP/R1R5 b - - 0 18"
      << "*";
  QTest::newRow("KOTH center #1")
      << variant << "r1b3nr/1pp2ppp/pk6/3p4/BP1K4/2P2N2/P4PPP/R1R5 b - - 0 19"
      << "1-0";
  QTest::newRow("KOTH center #2")
      << variant << "1q6/8/2B2p2/4k3/P1p5/1p1pn3/5K2/8 w - - 1 71"
      << "0-1";

  variant = "racingkings";

  QTest::newRow("Race black win")
      << variant << "6k1/3K4/3B4/8/8/8/8/8 w - - 0 1"
      << "0-1";
  QTest::newRow("Race unfinished")
      << variant << "6K1/3k4/3b4/8/8/8/8/8 b - - 0 1"
      << "*";
  QTest::newRow("Race white win") << variant << "6K1/8/3bk3/8/8/8/8/8 b - - 0 1"
                                  << "1-0";
  QTest::newRow("Race drawn") << variant << "3k2K1/8/3b4/8/8/8/8/8 w - - 1 1"
                              << "1/2-1/2";

  variant = "horde";

  QTest::newRow("Horde black win") << variant << "8/8/4k3/8/8/8/8/8 w - - 0 1"
                                   << "0-1";
  QTest::newRow("Horde draw stalemate")
      << variant << "8/8/1k6/5p2/5P2/5P2/8/8 w - - 0 1"
      << "1/2-1/2";
  QTest::newRow("Horde white win")
      << variant << "2k4R/R7/8/3PP3/8/8/8/8 b - - 0 1"
      << "1-0";

  variant = "extinction";

  QTest::newRow("extinction white win")
      << variant << "6k1/5p2/7p/3p4/p2pr3/b1BQ2Pq/r1B1P1RP/N6K b - - 0 34"
      << "1-0";
  ...
  QTest::newRow("kinglet white win")
      << variant << "8/8/4P3/2Q5/1P6/1P6/8/8 b - - 0 1"
      << "1-0";
  QTest::newRow("kinglet black win")
      << variant << "2k5/1pp3R1/6p1/r7/8/4K3/8/8 w - - 0 1"
      << "0-1";
  QTest::newRow("kinglet two") << variant << "8/8/6p1/8/8/4P3/8/8 w - - 0 1"
                               << "*";

  variant = "checkless";

  QTest::newRow("checkless white win")
      << variant << "K5kr/5Q2/8/8/8/8/8/8 b - - 0 1"
      << "1-0";

  variant = "coregal";

  QTest::newRow("coregal white win #1")
      << variant << "4Rqk1/p2p2pp/1pp2p2/8/8/3P4/PP3PPP/4Q1K1 b - - 0 1"
      << "1-0";
  QTest::newRow("coregal white win #2")
      << variant << "q3r1k1/R1Q2ppp/8/4n3/4PN2/3P3P/5PP1/6K1 b - - 0 27"
      << "1-0";

  variant = "grid";

  QTest::newRow("grid white win")
      << variant << "r6r/2kRN2p/pp6/2p5/5B2/3P1P2/PP3P1P/6K1 b - - 0 1"
      << "1-0";
  QTest::newRow("grid black win")
      << variant << "8/8/1p3R2/pkp5/2b1P1r1/5N2/Pb3P1P/3R2K1 w - - 2 28"
      << "0-1";
  QTest::newRow("grid black win2")
      << variant << "Q1bk1bnr/8/3p2p1/p3p3/8/4P3/PPPP2PP/RNB1K1qR w KQ - 0 1"
      << "0-1";
  ...
  QTest::newRow("grid draw stalemate")
      << variant << "8/8/8/8/pk6/KP6/2r5/8 w - - 0 1"
      << "1/2-1/2";
  ...
  QTest::newRow("twokings black win1")
      << variant << "8/2k5/4b1Pp/2p3K1/8/2P1p3/2k2q1K/B7 w - - 0 59"
      << "0-1";
  QTest::newRow("twokings black win2")
      << variant << "8/8/8/8/2k5/4kK2/5K2/2q5 w - - 0 1"
      << "0-1";

  variant = "shatranj";

  QTest::newRow("shatranj ongoing bk bare")
      << variant << "8/4k3/5R2/8/4K3/8/8/8 b - - 0 1"
      << "*";
  QTest::newRow("shatranj white win bk bare1")
      << variant << "8/4k3/5R2/8/4K3/8/8/8 w - - 0 1"
      << "1-0";
  QTest::newRow("shatranj draw both kings bare")
      << variant << "8/8/5k2/8/4K3/8/8/8 w - - 0 1"
      << "1/2-1/2";
  QTest::newRow("shatranj white win bk bare2")
      << variant << "8/3k4/5R2/8/4K3/8/8/8 b - - 0 1"
      << "1-0";
  QTest::newRow("shatranj white win bk bare3")
      << variant << "8/4k3/5R2/8/4K3/2P5/8/8 b - - 0 1"
      << "1-0";
  QTest::newRow("shatranj black win wk bare1")
      << variant << "8/8/7k/8/2K5/8/2q5/8 w - - 0 1"
      << "0-1";
  QTest::newRow("shatranj black win wk bare2")
      << variant << "8/8/7k/8/2K5/2q5/8/4q3 w - - 0 1"
      << "0-1";
  QTest::newRow("shatranj white mates")
      << variant << "r3k3/2PB1RN1/1n4P1/4PK2/1p3p2/1P6/Pp3P2/8 b - - 0 1"
      << "1-0";
  QTest::newRow("shatranj black mates")
      << variant << "7r/8/4bkqK/8/8/8/7R/8 w - - 0 1"
      << "0-1";
  QTest::newRow("shatranj white king stalemated")
      << variant << "8/8/5kqK/8/8/8/8/8 w - - 0 1"
      << "0-1";
  QTest::newRow("shatranj black king stalemated")
      << variant << "8/8/8/8/8/8/5KQk/8 b - - 0 1"
      << "1-0";

  variant = "courier";

  QTest::newRow("courier ongoing bk bare")
      << variant << "12/4k7/5W6/12/4K7/12/12/12 b - - 0 1"
      << "*";
  QTest::newRow("courier white win bk bare1")
      << variant << "12/4k7/5W6/12/4K7/12/12/12 w - - 0 1"
      << "1-0";
  QTest::newRow("courier white win bk bare2")
      << variant << "12/4k7/5W6/12/4K7/11E/12/12 b - - 0 1"
      << "1-0";

  variant = "makruk";

  QTest::newRow("makruk white win /w pawns: no counting")
      << variant << "7R/6Mk/5S2/7P/Pp6/8/2mnr3/K7 b - 0 0 129"
      << "1-0";

  QTest::newRow("makruk black win KNMvsK")
      << variant << "8/8/8/8/8/5nk1/6m1/6K1 w - 128 56 213"
      << "0-1";

  QTest::newRow("makruk full count black win KRvKM")
      << variant << "8/8/8/8/8/6k1/8/M1r3K1 w - 128 128 115"
      << "0-1";

  QTest::newRow("makruk board's honour draw KRvKM")
      << variant << "2r5/8/8/8/8/1k6/6K1/M7 b - 128 128 125"
      << "1/2-1/2";

  QTest::newRow("makruk board's honour draw KSMvKS")
      << variant << "8/8/8/4S3/2k1K3/1s6/7M/8 b - 128 128 236"
      << "1/2-1/2";

  QTest::newRow("makruk KNvK insufficient material")
      << variant << "8/8/1k6/3K4/8/3N4/8/8 b - 128 6 105"
      << "1/2-1/2";

  QTest::newRow("makruk KMMvK insufficient material")
      << variant << "8/8/6MM/8/8/2K5/k7/8 b - 128 8 99"
      << "1/2-1/2";

  QTest::newRow("makruk KMMvK win overrides insufficient material")
      << variant << "8/5KMk/6M1/8/8/8/8/8 b - 128 8 75"
      << "1-0";

  QTest::newRow("makruk KSMvK pieces' honour white win")
      << variant << "8/5KMk/7S/8/8/8/8/8 b - 88 52 174"
      << "1-0";

  QTest::newRow("makruk KRRvK pieces' honour white win")
      << variant << "8/8/8/2K1k3/8/4RR2/8/8 b - 16 14 128"
      << "1-0";

  QTest::newRow("makruk KRRvK pieces' honour ongoing")
      << variant << "8/8/8/2K1k3/8/3R1R2/8/8 w - 16 13 128"
      << "*";

  variant = "karouk";

  QTest::newRow("karouk KRRvKM black wins by check")
      << variant << "8/8/8/2K1k3/3m4/3R1R2/8/8 w - 128 13 128"
      << "0-1";

  variant = "asean";

  QTest::newRow("asean KQvK insufficient material")
      << variant << "8/8/8/5K2/1q6/8/8/k7 w - - 0 71"
      << "1/2-1/2";

  variant = "sittuyin";

  QTest::newRow("sittuyin draw by promotion stalemate, rule 3.9c7")
      << variant << "1k4PK/3r4/8/8/8/8/8/8[-] w - 0 0 1"
      << "1/2-1/2";

  variant = "ai-wok";

  QTest::newRow("ai-wok black win")
      << variant << "8/8/8/2sp2k1/8/3P4/4K1a1/7r w - - 0 1"
      << "0-1";

  variant = "jesonmor";

  QTest::newRow("jesonmor continue")
      << variant << "9/9/9/2n6/4N4/9/9/9/9 b - - 0 1"
      << "*";
  QTest::newRow("jesonmor white win 1")
      << variant << "9/9/9/2n6/4N4/9/9/9/9 w - - 0 1"
      << "1-0";
  QTest::newRow("jesonmor white win 2")
      << variant << "1nnn1n1nn/9/9/3n1n3/4N4/5N3/1N7/9/1N1N1NNN1 b - - 0 7"
      << "1-0";
  QTest::newRow("jesonmor black win")
      << variant << "9/9/Nn7/9/4n4/9/9/9/9 w - - 0 25"
      << "0-1";
  QTest::newRow("jesonmor no white pieces")
      << variant << "9/9/1n7/9/9/9/3n5/9/9 w - - 0 24"
      << "0-1";

  variant = "almost";

  QTest::newRow("almost fool's mate")
      << variant << "rnbckbnr/ppCppp1p/6p1/8/8/8/PPPPPPPP/RNB1KBNR b KQkq - 0 2"
      << "1-0";

  variant = "codrus";

  QTest::newRow("codrus black win")
      << variant << "7r/4b1pp/P7/6R1/8/2N1K3/1P1PP1PP/2B2BNR b - - 0 18"
      << "0-1";
}
...
void tst_Board::perft_data() const {
  ...
  QTest::newRow("startpos")
      << variant << "rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1"
      << 5 << Q_UINT64_C(4865609);
  QTest::newRow("pos2")
      << variant
      << "r3k2r/p1ppqpb1/bn2pnp1/3PN3/1p2P3/2N2Q1p/PPPBBPPP/R3K2R w KQkq -" << 4
      << Q_UINT64_C(4085603);
  QTest::newRow("pos3") << variant << "8/3K4/2p5/p2b2r1/5k2/8/8/1q6 b - -" << 2
                        << Q_UINT64_C(279);
  QTest::newRow("pos4") << variant << "8/2p5/3p4/KP5r/1R3p1k/8/4P1P1/8 w - -"
                        << 6 << Q_UINT64_C(11030083);
  ...
  QTest::newRow("gothic startpos")
      ...
      << 4 << Q_UINT64_C(808984);
  QTest::newRow("goth2") << variant
                         << "r1b1c2rk1/p4a1ppp/1ppq2pn2/3p1p4/3A1Pn3/1PN3PN2/"
                            "P1PQP1BPPP/3RC2RK1 w - -"
                         << 4 << Q_UINT64_C(7917813);
  QTest::newRow("goth3") << variant
                         << "r1b2k2nr/p1ppq1ppbp/n1Pcpa2p1/5p4/5P4/1p1PBCPN2/"
                            "PP1QP1BPPP/RN3KA2R w KQkq -"
                         << 4 << Q_UINT64_C(4869569);

  variant = "fischerandom";
  QTest::newRow("frc1") << variant << "1rk3r1/8/8/8/8/8/8/1RK1R3 w EBgb -" << 2
                        << Q_UINT64_C(464);
  QTest::newRow("frc2")
      << variant << "bnrbnkrq/pppppppp/8/8/8/8/PPPPPPPP/BNRBNKRQ w KQkq - 0 1"
      << 4 << Q_UINT64_C(233585);
  QTest::newRow("frc3") << variant
                        << "2rkr3/5PP1/8/5Q2/5q2/8/5pp1/2RKR3 w KQkq - 0 1" << 3
                        << Q_UINT64_C(71005);
  QTest::newRow("frc4") << variant
  ...
  QTest::newRow("atomic startpos")
      << variant << "rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1"
      << 5  // 3 plies: 8902, 4 plies: 197326, 5 plies: 4865037, 6 plies:
            // 118951457
      << Q_UINT64_C(4865037);
  QTest::newRow("atomic pos1")
      << variant << "8/8/8/8/8/8/3k4/rR4K1 w Q - 0 1"
      << 5  // 3 plies: 1797, 4 plies: 27928, 5 plies: 453449, 6 plies: 7667595
      << Q_UINT64_C(453449);
  QTest::newRow("atomic pos2")
      << variant << "r4b1r/2kb1N2/p2Bpnp1/8/2Pp3p/1P1PPP2/P5PP/R3K2R b KQ -"
  ...
  QTest::newRow("crazyhouse startpos")
      << variant << "rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1"
      << 5 << Q_UINT64_C(4888832);
  QTest::newRow("crazyhouse promo1") << variant
                                     << "3q1bkr/2p1pBp1/q1n3p1/1N2p3/1Pp5/"
                                        "P4Q~2/BBPp1PPP/R2K2NR[RPPn] b - - 0 28"
                                     << 3 << Q_UINT64_C(6386);
  ...
  QTest::newRow("chessgi2")
      ...
      << Q_UINT64_C(4493963);
  // TBD sjaakii (/wo dbl steps from first rank) 1 ply:161, 2 plies: 32816, 3
  // plies: 4434101
  ...
  QTest::newRow("berolina1")
      << variant << "3k1r2/1pp3p1/3P2p1/PR4p1/6p1/2P2Pn1/b3r1BP/3KN3 b - - 1 26"
      << 4  // 4 plies: 909365, 5 plies: 37601709
      << Q_UINT64_C(909365);

  variant = "racingkings";
  QTest::newRow("racingkings startpos")
      << variant << "8/8/8/8/8/8/krbnNBRK/qrbnNBRQ w - - 0 1"
      << 4  // 4 plies: 296242, 5 plies: 9472927, 6 plies: 298712641
      << Q_UINT64_C(296242);

  variant = "horde";
  QTest::newRow("horde v2 startpos") << variant
                                     << "rnbqkbnr/pppppppp/8/1PP2PP1/PPPPPPPP/"
                                        "PPPPPPPP/PPPPPPPP/PPPPPPPP w kq - 0 1"
  ...
  QTest::newRow("horde dunsany startpos")
      ...
      << Q_UINT64_C(775839);
  QTest::newRow("horde3") << variant
                          << "rnbqkbnr/6p1/2p1Pp1P/P1PPPP2/Pp4PP/1p2PPPP/"
                             "1P2PPPP/PP1nPPPP b kq a3 0 18"
  ...
  QTest::newRow("grid pos2")
      ...
      << "r3k2r/p1ppqpb1/bn2pnp1/3PN3/1p2P3/2N2Q1p/PPPBBPPP/R3K2R w KQkq -" << 4
      << Q_UINT64_C(1853429);
  QTest::newRow("grid pos3") << variant << "8/3K4/2p5/p2b2r1/5k2/8/8/1q6 b - -"
                             << 2 << Q_UINT64_C(142);
  QTest::newRow("grid pos4")
      << variant << "8/2p5/3p4/KP5r/1R3p1k/8/4P1P1/8 w - -" << 6
      << Q_UINT64_C(1477948);
  QTest::newRow("grid pos5")
      << variant << "r1bqkbnr/pppppppp/n7/8/8/5N2/PPPPPPPP/RNBQKB1R w KQkq -"
  ...
  QTest::newRow("knightmate startpos")
      << variant << "rmbqkbmr/pppppppp/8/8/8/8/PPPPPPPP/RMBQKBMR w KQkq - 0 1"
  ...
  QTest::newRow("chancellor promotion")
      << variant << "4k4/1P7/K8/9/9/9/9/9/9 w - - 0 1" << 2 << Q_UINT64_C(37);
  ...
  QTest::newRow("modern promotion")
      << variant << "4k4/1P7/K8/9/9/9/9/9/9 w - - 0 1" << 2 << Q_UINT64_C(39);
  ...
  QTest::newRow("losers startpos")
      << variant << "rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1"
      << 5  // 4 plies: 152955, 5 plies: 2723795, 6 plies: 46038682, 7 plies:
            // 757349642
      << Q_UINT64_C(2723795);
  ...
  QTest::newRow("antichess startpos")
      << variant << "rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w - - 0 1"
      << 5  // 4 plies: 153299, 5 plies: 2732672, 6 plies: 46264162, 7 plies:
            // 762010688
      << Q_UINT64_C(2732672);
  ...
  QTest::newRow("suicide endgame1")
      << variant << "8/2b5/8/3B4/8/8/2P5/8 b - - 0 1"
      << 5  // 5 plies: 116051, 6 plies: 1218696
      << Q_UINT64_C(116051);
  QTest::newRow("suicide endgame2")
      << variant << "8/1kKP4/8/8/8/8/8/6n1 b - - 0 1"
      << 3  // 3 plies: 5, 4 plies: 0
      << Q_UINT64_C(5);
  QTest::newRow("suicide endgame3")
      << variant << "8/k1KP4/8/8/8/8/8/6n1 b - - 0 1" << 7  // 7 plies: 2891980
      << Q_UINT64_C(2891980);
  ...
  QTest::newRow("codrus startpos")
      << variant << "rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1"
      << 4  // 4 plies: 153299, 5 plies: 2732672, 6 plies: 46263517, 7 plies:
            // 762067389
      << Q_UINT64_C(153299);
  QTest::newRow("codrus endgame1")
      << variant << "5bnr/2pp2pp/P4k2/R3Q1P1/8/2N1K3/1P1PP1PP/2B2BNR w - - 1 15"
      << 4  // 1 ply: 3, 2 plies: 1, 3 plies: 2, 4 plies: 19
      << Q_UINT64_C(19);

  variant = "threekings";
  QTest::newRow("threekings startpos")
      << variant << "knbqkbnk/pppppppp/8/8/8/8/PPPPPPPP/KNBQKBNK w - - 0 1"
      << 5  // 4 plies: 199514, 5 plies: 4971357, 6 plies: 123493813
      << Q_UINT64_C(4971357);

  variant = "shatranj";
  QTest::newRow("shatranj startpos")
      << variant << "rnbkqbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBKQBNR w - - 0 1"
  ...
  QTest::newRow("courier startpos")
      << variant
      << "rnebmkfwbenr/pppppppppppp/12/12/12/12/PPPPPPPPPPPP/RNEBMKFWBENR w - "
         "- 0 1"
      << 5  // 4 plies: 180571, 5 plies: 4139349, 6 plies: 94789147
      << Q_UINT64_C(4139349);
  QTest::newRow("courier traditional")
      << variant
      << "rnebmk1wbenr/1ppppp1pppp1/6f5/p5p4p/P5P4P/6F5/1PPPPP1PPPP1/"
         "RNEBMK1WBENR w - - 0 1"
  ...
  QTest::newRow("makruk startpos")
      << variant << "rnsmksnr/8/pppppppp/8/8/PPPPPPPP/8/RNSKMSNR w - 0 0 1"
      << 5  // 4 plies: 273026, 5 plies: 6223994, 6 plies: 142078049
      << Q_UINT64_C(6223994);

  variant = "cambodian";
  QTest::newRow("cambodian startpos")
      << variant << "rnsmksnr/8/pppppppp/8/8/PPPPPPPP/8/RNSKMSNR w DEde 0 0 1"
  ...
  QTest::newRow("asean startpos")
      << variant << "rnbqkbnr/8/pppppppp/8/8/PPPPPPPP/8/RNBQKBNR w - - 0 1"
  ...
  QTest::newRow("twokings startpos")
      << variant
      << "rnbqkknr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKKNR w KQkq - 0 1"
      // asymmetrical variant 4 plies: 192312, 5 plies: 4629168, 6 plies:
      // 110762251
      //  symmetrical variant 4 plies: 192332, 5 plies: 4629764, 6 plies:
      //  110829475
      << 5 << Q_UINT64_C(4629168);
  QTest::newRow("twokings endgame1")
      << variant << "8/8/p1k5/1p1r1K1p/1P5P/P1K5/8/8 b - - 0 121"
  ...
  QTest::newRow("twokings symmetrical variant, startpos")
      ...
      //  symmetrical variant 4 plies: 192332, 5 plies: 4629764, 6 plies:
      //  110829475
      << 5 << Q_UINT64_C(4629764);

  variant = "grand";
  QTest::newRow("grand startpos")
      << variant
      << "r8r/1nbqkcabn1/pppppppppp/10/10/10/10/PPPPPPPPPP/1NBQKCABN1/R8R w - "
         "- 0 1"
      << 3  // 3plies: 259514, 4 plies: 15921643, 5 plies: 959883584
      << Q_UINT64_C(259514);
  QTest::newRow("grand endgame1")
      << variant << "10/4k5/6P3/10/10/10/10/10/1p2K5/10 w - - 0 1"
  ...
  QTest::newRow("chigorin startpos")
      << variant << "rbbqkbbr/pppppppp/8/8/8/8/PPPPPPPP/RNNCKNNR w KQkq - 0 1"
      << 4  // 4 plies: 229973, 5 plies: 6624527, 6 plies: 156383743
      << Q_UINT64_C(229973);
  QTest::newRow("chigorin promotion")
      << variant << "8/KP6/8/4k3/8/8/6p1/8 w - - 0 1"
  ...
  QTest::newRow("placement startpos")
      << variant << "8/pppppppp/8/8/8/8/PPPPPPPP/8[KQRRBBNNkqrrbbnn] w - - 0 1"
  ...
  QTest::newRow("gustav3 startpos")
      << variant
      << "arnbqkbnra/*pppppppp*/*8*/*8*/*8*/*8*/*PPPPPPPP*/ARNBQKBNRA w KQkq - "
         "0 1"
