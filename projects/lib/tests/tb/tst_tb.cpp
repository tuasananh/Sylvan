...
void tst_Tb::tbInitialized() {
  QVERIFY2(SyzygyTablebase::tbAvailable(3), "3-piece tablebases unavailable");
  QVERIFY2(SyzygyTablebase::tbAvailable(4), "4-piece tablebases unavailable");
}
...
void tst_Tb::positions_data() const {
  ...
  QTest::newRow("startpos")
      ...
      << "*" << 0;
  QTest::newRow("pos2") << "7k/8/8/8/5KP1/8/8/8 w - - 0 1"
                        << "1-0" << 7;
  QTest::newRow("pos3") << "7k/8/8/6P1/5K2/8/8/8 w - - 0 1"
                        << "1/2-1/2" << 0;
  QTest::newRow("pos4") << "8/2k5/8/6N1/5K2/1r6/8/8 w - - 0 1"
                        << "1/2-1/2" << 0;
  QTest::newRow("pos5") << "1n6/8/8/8/8/8/6R1/2K1k3 w - - 0 1"
                        << "1-0" << 48;
  QTest::newRow("pos6") << "3n4/8/8/8/7R/8/8/2K1k3 w - - 0 1"
                        << "1-0" << 48;
  QTest::newRow("pos7") << "8/8/3n4/8/8/8/4R3/2K2k2 w - - 0 1"
                        << "1-0" << 44;
  QTest::newRow("pos8") << "8/8/7R/n7/8/8/8/2K2k2 w - - 0 1"
                        << "1-0" << 44;
  QTest::newRow("pos9") << "4n3/8/8/8/7R/8/8/3K1k2 w - - 0 1"
                        << "1-0" << 46;
  QTest::newRow("pos10") << "2B5/8/8/8/8/2K2k2/6p1/8 b - - 0 1"
                         << "0-1" << 1;
  QTest::newRow("pos11") << "8/B7/8/8/8/2K2k2/6p1/8 b - - 0 1"
                         << "1/2-1/2" << 0;
