...
bool ChessPlayer::hasError() const { return !m_error.isEmpty(); }
...
bool ChessPlayer::canPlayAfterTimeout() const { return m_canPlayAfterTimeout; }
...
bool ChessPlayer::areClaimsValidated() const { return m_validateClaims; }
