...
EngineConfiguration::~EngineConfiguration() { qDeleteAll(m_options); }
...
QString EngineConfiguration::name() const { return m_name; }

QString EngineConfiguration::command() const { return m_command; }

QString EngineConfiguration::workingDirectory() const {
  return m_workingDirectory;
}

QString EngineConfiguration::stderrFile() const { return m_stderrFile; }

QString EngineConfiguration::protocol() const { return m_protocol; }
...
bool EngineConfiguration::redEvalPov() const { return m_redEvalPov; }

void EngineConfiguration::setRedEvalPov(bool redEvalPov) {
  m_redEvalPov = redEvalPov;
}

bool EngineConfiguration::pondering() const { return m_pondering; }

void EngineConfiguration::setPondering(bool enabled) { m_pondering = enabled; }
