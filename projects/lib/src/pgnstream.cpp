...
PgnStream::~PgnStream() { delete m_board; }
...
qint64 PgnStream::lineNumber() const { return m_lineNumber; }
...
QByteArray PgnStream::tokenString() const { return m_tokenString; }

PgnStream::TokenType PgnStream::tokenType() const { return m_tokenType; }

QByteArray PgnStream::tagName() const { return m_tagName; }

QByteArray PgnStream::tagValue() const { return m_tagValue; }
