...
inline Side Board::sideToMove() const { return m_side; }

inline Side Board::startingSide() const { return m_startingSide; }

inline QString Board::startingFenString() const { return m_startingFen; }

inline quint64 Board::key() const { return m_key; }

inline void Board::xorKey(quint64 key) { m_key ^= key; }
