...
TimeControlDialog::TimeControlDialog(const TimeControl &tc, QWidget *parent)
  ...
  connect(ui->m_tournamentRadio, SIGNAL(clicked()), this,
          SLOT(onTournamentSelected()));
  connect(ui->m_timePerMoveRadio, SIGNAL(clicked()), this,
          SLOT(onTimePerMoveSelected()));
...
TimeControlDialog::~TimeControlDialog() { delete ui; }
