...
NewGameDialog::NewGameDialog(EngineManager *engineManager, QWidget *parent)
  ...
  connect(ui->m_configureRedEngineButton, SIGNAL(clicked()), this,
          SLOT(configureEngine()));
  connect(ui->m_configureBlackEngineButton, SIGNAL(clicked()), this,
          SLOT(configureEngine()));
  ...
  connect(ui->m_redEngineComboBox, SIGNAL(currentIndexChanged(int)), this,
          SLOT(onEngineChanged(int)));
  connect(ui->m_blackEngineComboBox, SIGNAL(currentIndexChanged(int)), this,
          SLOT(onEngineChanged(int)));
...
PlayerBuilder *NewGameDialog::createPlayerBuilder(Chess::Side side) const {
  ...
  bool ignoreFlag =
      QSettings().value("games/human_can_play_after_timeout", true).toBool();
