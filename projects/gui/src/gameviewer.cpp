...
GameViewer::GameViewer(Qt::Orientation orientation, QWidget* parent,
  ...
  connect(m_viewFirstMoveBtn, SIGNAL(clicked()), this,
          SLOT(viewFirstMoveClicked()));
  ...
  connect(m_viewPreviousMoveBtn, SIGNAL(clicked()), this,
          SLOT(viewPreviousMoveClicked()));
  ...
  connect(m_viewNextMoveBtn, SIGNAL(clicked()), this,
          SLOT(viewNextMoveClicked()));
  ...
  connect(m_viewLastMoveBtn, SIGNAL(clicked()), this,
          SLOT(viewLastMoveClicked()));
...
void GameViewer::setGame(ChessGame* game) {
  ...
  connect(m_game, SIGNAL(fenChanged(QString)), this,
          SLOT(onFenChanged(QString)));
  connect(m_game, SIGNAL(moveMade(Chess::GenericMove, QString, QString)), this,
          SLOT(onMoveMade(Chess::GenericMove)));
  connect(m_game, SIGNAL(humanEnabled(bool)), m_boardView,
